...
async def reimport_sim14():
    ...
    print("Starting Global Re-Import for 3Q_SIM14 with Quantity Fix and Fuzzy Deduplication...")
    await parser.run_import(
        paths=folders,
        filter_symbol="CL",
        account_filter=["3Q_SIM14"],
        days_lookback=None # Full history
    )
    print("Import Finished.")
    print(f"Stats: {parser.stats}")

if __name__ == "__main__":
    asyncio.run(reimport_sim14())
